...
int main(int argc, char *argv[]) {
  ...
  ************************************************/
  ...
  CompressMatrix(value, column, row, affinity, num_feat_1 * num_feat_2,
                 num_feat_1 * num_feat_2);
  ...
  ************************************************/
  ...
  for (int iter = 0; iter < num_iters; ++iter) {
    ...
    mkl_dcsrmv("N", &len_eigen_vec, &len_eigen_vec, &one, "G**C", value.data(), column.data(), pntrb, pntre, h_eigen_old.data(), &zero, h_eigen_new.data());
